...
-- Tiempo de generación: 15-07-2019 a las 21:03:18
...
--
-- Base de datos: `id9001333_valknut`
--
...
(1, 'Franco Cipolla', 'francoc10@live.com.ar', 'franco', '1234', 1, 'feb034ccfb6918d1e90a1d9b46a1a3d0', 1, 'img/img_usuarios/1562858733_franco.jpg'),
...
--
ALTER TABLE `galerias`
  MODIFY `id_gale` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `img_galeria`
--
ALTER TABLE `img_galeria`
  MODIFY `id_img` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=97;
COMMIT;
